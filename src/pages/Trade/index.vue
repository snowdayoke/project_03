  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="address in userAddress" :key="address.id">
        <span class="username" :class="{selected:address.isDefault=='1'}" @click="changeDefault(address,userAddress)">{{ address.consignee }}</span>
        <p>
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let data = {
          ...
          consigneeTel: this.defaultAddress.phoneNum, //最终收件人的电话
          deliveryAddress: this.defaultAddress.fullAddress, //最终收件人的地址
          paymentWa: "ONLINE",  //支付方式
